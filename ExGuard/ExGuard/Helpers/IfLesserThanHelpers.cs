...
namespace ExGuard.Helpers
{
    ...
    {
        public static IValidatable<int> IfLesserThan([NotNull] this IValidatable<int> validatable, int limit)
            => ValidateInt(validatable, limit: limit, message: null, exceptionType: null);

        public static IValidatable<int> IfLesserThan([NotNull] this IValidatable<int> validatable, int limit, string message)
            => ValidateInt(validatable, limit: limit, message: message, exceptionType: null);

        public static IValidatable<int> IfLesserThan([NotNull] this IValidatable<int> validatable, int limit, Type exceptionType)
            => ValidateInt(validatable, limit: limit, message: null, exceptionType: exceptionType);

        public static IValidatable<int> IfLesserThan([NotNull] this IValidatable<int> validatable, int limit, string message, Type exceptionType)
            => ValidateInt(validatable, limit: limit, message: message, exceptionType: exceptionType);

        public static IValidatable<double> IfLesserThan([NotNull] this IValidatable<double> validatable, double limit)
            => ValidateDouble(validatable, limit: limit, message: null, exceptionType: null);

        public static IValidatable<double> IfLesserThan([NotNull] this IValidatable<double> validatable, double limit, string message)
            => ValidateDouble(validatable, limit: limit, message: message, exceptionType: null);

        public static IValidatable<double> IfLesserThan([NotNull] this IValidatable<double> validatable, double limit, Type exceptionType)
            => ValidateDouble(validatable, limit: limit, message: null, exceptionType: exceptionType);

        public static IValidatable<double> IfLesserThan([NotNull] this IValidatable<double> validatable, double limit, string message, Type exceptionType)
            => ValidateDouble(validatable, limit: limit, message: message, exceptionType: exceptionType);

        public static IValidatable<float> IfLesserThan([NotNull] this IValidatable<float> validatable, float limit)
            => ValidateFloat(validatable, limit: limit, message: null, exceptionType: null);

        public static IValidatable<float> IfLesserThan([NotNull] this IValidatable<float> validatable, float limit, string message)
            => ValidateFloat(validatable, limit: limit, message: message, exceptionType: null);

        public static IValidatable<float> IfLesserThan([NotNull] this IValidatable<float> validatable, float limit, Type exceptionType)
            => ValidateFloat(validatable, limit: limit, message: null, exceptionType: exceptionType);

        public static IValidatable<float> IfLesserThan([NotNull] this IValidatable<float> validatable, float limit, string message, Type exceptionType)
