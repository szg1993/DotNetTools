...
namespace ExGuard.Helpers
{
    ...
    {
        public static int ThrowIfGreater([NotNull] this int validatable, int limit)
            => ValidateInt(validatable, limit: limit, message: null, exceptionType: null);

        public static int ThrowIfGreater([NotNull] this int validatable, int limit, string message)
            => ValidateInt(validatable, limit: limit, message: message, exceptionType: null);

        public static int ThrowIfGreater([NotNull] this int validatable, int limit, Type exceptionType)
            => ValidateInt(validatable, limit: limit, message: null, exceptionType: exceptionType);

        public static int ThrowIfGreater([NotNull] this int validatable, int limit, string message, Type exceptionType)
            => ValidateInt(validatable, limit: limit, message: message, exceptionType: exceptionType);

        public static double ThrowIfGreater([NotNull] this double validatable, double limit)
            => ValidateDouble(validatable, limit: limit, message: null, exceptionType: null);

        public static double ThrowIfGreater([NotNull] this double validatable, double limit, string message)
            => ValidateDouble(validatable, limit: limit, message: message, exceptionType: null);

        public static double ThrowIfGreater([NotNull] this double validatable, double limit, Type exceptionType)
            => ValidateDouble(validatable, limit: limit, message: null, exceptionType: exceptionType);

        public static double ThrowIfGreater([NotNull] this double validatable, double limit, string message, Type exceptionType)
